...
| 4 | **Browse — 37 sources** | `browse` (`BrowseScreen`), Browse tab | A source browse grid (e.g. Royal Road with the filter row) **or** the Plugins source grid showing the breadth (Royal Road, AO3, Gutenberg, Wikipedia, RSS, …). Conveys "37 sources." |
