...
/**
 * Google Drive source (scaffolded by scripts/new-source.sh).
 *
 * Every member is stubbed with an honest [FictionResult.NotFound] — wire each
 * one to [GoogleDriveApi] and map the response into the core-data models. The
...
internal class GoogleDriveSource @Inject constructor(
    @Suppress("unused") private val api: GoogleDriveApi,
) : FictionSource {

    override val id: String = "google-drive"
